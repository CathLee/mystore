			...
			<tr>
				<td colspan="10" style="padding-left: 1450px"><strong>总数量：<span
					...
					<button type="button" class="btn btn-danger"
						...
						onclick="window.location='<%=basePath%>order/genOrder'">
	...
	<script type="text/javascript">
		function changeNum(inputObj,oldNum,book_id){
			...
			if(sure){
				...
				//提交给服务器修改该项的数量
				window.location.href="<%=basePath%>user/changeNum/num="+num+"&book_id="+book_id;
			}else{
				//显示原来的值
		...
		function delOneItem(book_id) {
			...
			if (sure) {
				window.location.href = "<%=basePath%>user/delItem/book_id="+book_id;
				alert("删除成功！！");
			}
		}
	</script>
