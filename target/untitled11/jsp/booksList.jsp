	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li><a href="<%=basePath%>manage/wxys">文学艺术</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>manage/rwsk">人文社科</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>manage/sets">少儿童书</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>manage/jyks">教育考试</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>manage/jjjr">经济金融</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>manage/kxjs">科学技术</a></li>
			</ul>
			<!-- 搜索框 -->
			<div style="float: right; margin-right: 7px">
				<form class="navbar-form navbar-left"
					action="<%=basePath%>manage/search"
					method="post">
		...
		<table class="table table-bordered table-hover" style="width: 100%">
			...
			<c:forEach items="${books}" var="s" varStatus="vs">
				<tr class="active">
					...
					<td><a
						href="<%=basePath%>manage/editBookUI&book_id=${s.book_id}">编辑</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<a
						href="<%=basePath%>manage/delBook&book_id=${s.book_id}"
