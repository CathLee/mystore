	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a target="_parent" href="<%=basePath%>/index.jsp"><img style="width: 288px;
    height: 50px;"
				...
				<c:if test="${!empty user}">
					<div style="float: right; margin-right: 7px; margin-top: 10px">
						<a class="btn btn-default btn-sm" target="_parent"
						   href="${pageContext.request.contextPath}/user/layout"
						   role="button">注销</a>
					</div>
					<div style="float: right; margin-right: 7px; margin-top: 10px">
						<a class="btn btn-default btn-sm" target="_parent"
						   href="<%=basePath%>jsp/showCart.jsp" role="button">购物车</a>
					</div>
					<div style="float: right; margin-right: 7px; margin-top: 10px">
						<a class="btn btn-default btn-sm" target="_parent"
						   href="<%=basePath%>user/showFavorite"
						   role="button">收藏夹</a>
					</div>
				</c:if>
				<div style="float: right; margin-right: 7px; margin-top: 10px">
					<a class="btn btn-default btn-sm"
					   href="${pageContext.request.contextPath}/manage/managerLogin.jsp"
					   role="button">管理员入口</a>
				</div>
			</div>
		</div>
	...
	<div class="container-fluid">
		<div id="carousel-example-generic" class="carousel slide"
			...
			<div class="carousel-inner" role="listbox">
				<div class="item active" style="height: 218px;">
					<img src="<%=basePath%>/img/lb_01.jpg" style="margin-left: 25%">
	...
	<div class="container-fluid">
		...
		<div class="collapse navbar-collapse"
			...
			<ul class="nav navbar-nav">
				<li><a href="<%=basePath%>user/wxys">文学艺术</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>user/rwsk">人文社科</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>user/sets">少儿童书</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>user/jyks">教育考试</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>user/jjjr">经济金融</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				<li><a href="<%=basePath%>user/kxjs">科学技术</a></li>
			</ul>
			<!-- 搜索框 -->
			<div style="float: right; margin-right: 7px">
				<form class="navbar-form navbar-left"
					  action="<%=basePath%>user/search" method="post">
					<div class="form-group">
